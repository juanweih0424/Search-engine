...
def dict_to_file(index_dict, count):
    with open('/Users/wangtianhe/Desktop/CS121/Indexing/indexes_test_ver2_'+str(count)+'.json', 'w') as j:
...
def run():
    ...
    #sortResult(indexes)
    with open('/Users/wangtianhe/Desktop/CS121/Indexing/word_count_page_ver2.json', 'w') as j:
        json.dump(list(word_cout_dict.items()), j)
    with open('/Users/wangtianhe/Desktop/CS121/Indexing/doc_id_ver2.json', 'w') as j:
